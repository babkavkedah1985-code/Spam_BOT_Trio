...
##
### Настройки фильтра
##MUTE_DURATION: int = 300  # 1200 секунд (20 минут)
##
### Слова-триггеры
##TRIGGER_WORDS: Set[str] = {
##    "пачему", "почиму", "пачиму", "почему", "как",
##    "добавить", "дабавить", "дабавте", "добавте", "добавьте", "дабавьте",
##    "номер", "клоун",
##    "заработай", "бизнес", "пассивный доход",
